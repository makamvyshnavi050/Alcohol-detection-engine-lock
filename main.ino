// Alcohol-detection-engine-lock Arduino Code
...
void loop() 
{
  ...
  Serial.println(alcoholLevel); // Display raw alcohol level reading on Serial Monitor
  ...
  delay(2000);      // Delay for 2 seconds before the next sensor reading
}
